...
import type { ChunkId, DocumentId, SectionId } from '../../../src/features/jets-ghost/corpus/types';
import {
  assemblePrompt,
  toCitationNeutralModelHistory,
} from '../../../src/features/jets-ghost/prompt/assemble';
...
import { estimateTokens } from '../../../src/features/jets-ghost/tokenEstimate';
...
function budget(overrides: Partial<ContextBudget> = {}): ContextBudget {
  return { ...JETS_GHOST_CONTEXT, ...overrides };
}
