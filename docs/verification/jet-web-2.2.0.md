...
| UI/runtime dependencies | `framer-motion@12.42.2`, `lucide-react@1.25.0`                                                                                                    | Framer Motion phase 2 complete; Lucide phase 3 pending                 |
| Build/test dependencies | `esbuild@0.28.1`, `tsx@4.23.1`, `@testing-library/jest-dom@7.0.0`                                                                                 | esbuild and tsx phase 2 complete; jest-dom phase 4 pending             |
