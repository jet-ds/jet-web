  ...
  theme: {
    extend: {
      colors: {
        ...
        'control-disabled-fill': 'var(--color-control-disabled-fill)',
        'control-disabled-foreground': 'var(--color-control-disabled-foreground)',
        'control-stop-fill': 'var(--color-control-stop-fill)',
        'control-stop-hover': 'var(--color-control-stop-hover)',
        'control-stop-foreground': 'var(--color-control-stop-foreground)',
